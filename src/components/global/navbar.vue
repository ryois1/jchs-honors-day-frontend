<template>
  <div>
    <b-navbar
      ...
      variant="dark"
    >
      <b-navbar-brand :to="{ name: 'Home' }"><b-img-lazy src="/static/jchs_patriots_logo_nav.png" width="30" height="30" alt="JCHS Patriots Mascot" class="d-inline-block align-top"></b-img-lazy>JCHS Honors Day</b-navbar-brand>
