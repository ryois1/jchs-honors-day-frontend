  ...
  <div id="certs">
        <b-container fluid>
            <b-row>
                ...
                <b-col><h3>You need to upload <b-badge>{{this.CERTS_NEEDED - this.UPLOADED_COUNT}}</b-badge> out of <b-badge>{{this.CERTS_NEEDED}}</b-badge> certificates</h3></b-col>
            </b-row>
            <b-row>
                <b-col>
                    <vue-dropzone ref="myVueDropzone" id="dropzone" v-on:vdropzone-success="dropzoneUploaded" :options="dropzoneOptions" :duplicateCheck="true"></vue-dropzone>
                </b-col>
            </b-row>
            <div id="certstable">
            <b-row>
                <b-col>
                    <b-table :tbody-tr-class="rowClass" bordered show-empty :items="CERTS_NEEDED_ARRAY" :fields="fields">
                </b-table>
                </b-col>
            </b-row>
            </div>
        ...
        return {
            ...
            dropzoneOptions: {
                ...
                accept: function(file, done) {
                    if (vm.CERTS_NEEDED_ARRAY.find(element => element.cert_file_name = file.name)) {
                        done();
                    }
                    else { done("Invalid file name"); }
                },
